<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/CuciKawatHitam/create_dtr'); ?>"> Create Data Timbang Rongsok (DTR) </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12">
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/CuciKawatHitam/save_dtr'); ?>">  
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="no_skb" name="no_skb" readonly="readonly"
                                class="form-control myline" style="margin-bottom:5px" 
                                value="<?php echo $header['no_skb']; ?>">
                            
                            <input type="hidden" id="skb_id" name="skb_id" value="<?php echo $header['id']; ?>">
                        </div>
                    </div>                    
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <?php
                                ...
                                foreach ($details as $row){
                                    ...
                                    echo '<input type="hidden" name="myDetails['.$no.'][skb_detail_id]" value="'.$row->id.'">';
...
function simpanData(){
    ...
    if($.trim($("#tanggal").val()) == ""){
        ...
        if(item_check==0){
            $('#message').html("Silahkan pilih item kawat yang akan di-create DTR!"); 
            $('.alert-danger').show(); 
        }else{
            $('#message').html("");
            $('.alert-danger').hide(); 
