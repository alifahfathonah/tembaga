<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/PengirimanSample/surat_jalan'); ?>"> Surat Jalan </a> 
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/PengirimanSample/edit_surat_jalan'); ?>"> Edit Surat Jalan </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/PengirimanSample/update_surat_jalan'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select id="request_sample_id" name="request_sample_id" class="form-control myline select2me" 
                                data-placeholder="Silahkan pilih..." style="margin-bottom:5px">
                                <option value="<?php echo $header['request_sample_id']; ?>"><?php echo $header['no_request']; ?></option>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/PengirimanSample/surat_jalan'); ?>" class="btn blue-hoki"> 
...
function simpanData(){
    if($.trim($("#tanggal").val()) == ""){
        ...
        $('.alert-danger').show(); 
    }else if($.trim($("#request_sample_id").val()) == ""){
        $('#message').html("Silahkan pilih no. request!");
        $('.alert-danger').show(); 
...
function loadDetail(id){
    $.ajax({
        type:"POST",
        url:'<?php echo base_url('index.php/PengirimanSample/load_detail_surat_jalan'); ?>',
        data:"id="+ id,
...
function get_uom(id){
    $.ajax({
        url: "<?php echo base_url('index.php/PengirimanSample/get_uom_ampas'); ?>",
        async: false,
        type: "POST",
        data: "id="+id,
        dataType: "json",
...
function saveDetail(){
    if($.trim($("#ampas_id").val()) == ""){
        $('#message').html("Silahkan pilih detail item surat jalan!");
        $('.alert-danger').show();  
        ...
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/PengirimanSample/save_detail_surat_jalan'); ?>',
            data:{
                id:$('#id').val(),
...
function hapusDetail(id){
    var r=confirm("Anda yakin menghapus detail surat jalan ini?");
    if (r==true){
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/PengirimanSample/delete_detail_surat_jalan'); ?>',
            data:"id="+ id,
            success:function(result){
                if(result['message_type']=="sukses"){
                    loadDetail($('#id').val());
...
function get_type_kendaraan(id){
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('index.php/PengirimanSample/get_type_kendaraan'); ?>",
        data: {id: id},
        cache: false,
        success: function(result) {
...
function get_alamat(id){
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('index.php/PengirimanSample/get_alamat'); ?>",
        data: {id: id},
        cache: false,
        success: function(result) {
    ...
    $.ajax({
        url: "<?php echo base_url('index.php/PengirimanSample/get_rs_list'); ?>",
        async: false,
        type: "POST",
        data: "id="+id,
        dataType: "html",
        success: function(result) {
            $('#request_sample_id').html(result);
        }
    })
}
