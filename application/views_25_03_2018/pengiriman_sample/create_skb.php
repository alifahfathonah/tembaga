<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/PengirimanSample/create_skb'); ?>"> Create Surat Keluar Barang (SKB)</a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12">
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/PengirimanSample/save_skb'); ?>">  
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="hidden" name="request_sample_id" id="request_sample_id" value="<?php echo $header['id']; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="marketing" name="marketing" 
                                class="form-control myline" style="margin-bottom:5px" readonly="readonly" 
                                value="<?php echo $header['marketing']; ?>">
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <?php
                                ...
                                foreach ($details as $row){
                                    ...
                                    echo '<input type="hidden" name="myDetails['.$no.'][request_sample_detail_id]" value="'.$row->id.'">';
                                    ...
                                    echo '<td><input type="text" id="qty_'.$no.'" name="myDetails['.$no.'][qty]" '
                                            . 'class="form-control myline" value="'.$row->qty.'" maxlength="10" '
...
function simpanData(){
    ...
    if($.trim($("#tanggal").val()) == ""){
        ...
        if(item_check==0){
            $('#message').html("Silahkan pilih item yang akan di-create SKB!"); 
            $('.alert-danger').show(); 
        }else{
            $('#message').html("");
            $('.alert-danger').hide(); 
