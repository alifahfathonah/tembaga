<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/CuciKawatHitam/edit'); ?>"> Create Surat Permintaan Barang (SPB) </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/CuciKawatHitam/update'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/CuciKawatHitam'); ?>" class="btn blue-hoki"> 
...
function loadDetail(id){
    $.ajax({
        type:"POST",
        url:'<?php echo base_url('index.php/CuciKawatHitam/load_detail'); ?>',
        data:"id="+ id,
...
function get_uom(id){
    $.ajax({
        url: "<?php echo base_url('index.php/CuciKawatHitam/get_uom'); ?>",
        async: false,
        type: "POST",
        data: "id="+id,
        dataType: "json",
...
function saveDetail(){
    if($.trim($("#rongsok_id").val()) == ""){
        $('#message').html("Silahkan pilih item kawat!");
        $('.alert-danger').show(); 
    }else if($.trim($("#qty").val()) == ""){
        $('#message').html("Jumlah batang harus diisi, tidak boleh kosong!");
        $('.alert-danger').show(); 
    }else{
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/CuciKawatHitam/save_detail'); ?>',
            data:{
                id:$('#id').val(),
...
function hapusDetail(id){
    ...
    if (r==true){
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/CuciKawatHitam/delete_detail'); ?>',
            data:"id="+ id,
            success:function(result){
                if(result['message_type']=="sukses"){
                    loadDetail($('#id').val());
