...
<div class="row">                            
    <div class="col-md-12"> 
        <?php
            if( ($group_id==1)||($hak_akses['request_barang_list']==1) ){
        ?>
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-truck"></i>Request Barang Pengganti List
                </div>                  
            </div>
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <?php
                                if( ($group_id==1 || $hak_akses['create_dtr']==1) && $data->ready_to_skb>0 && $data->status==1){
                                    echo '<a class="btn btn-circle btn-xs green-seagreen" href="'.base_url().'index.php/Retur/create_skb/'.$data->id.'" 
                        ...
                        <td style="text-align:center"> 
                            <?php
                                if(($group_id==1 || $hak_akses['edit_request_barang']==1) && ($data->status==0 || $data->status==9)){
                            ?>
                            <a class="btn btn-circle btn-xs green" href="<?php echo base_url(); ?>index.php/Retur/edit_request_barang/<?php echo $data->id; ?>" 
                               style="margin-bottom:4px"> &nbsp; <i class="fa  fa-pencil"></i> Edit &nbsp; </a>
                            <?php
                                }
                                if($group_id==1 || $hak_akses['view']==1){
                            ?>
                            <a class="btn btn-circle btn-xs blue-ebonyclay" href="<?php echo base_url(); ?>index.php/Retur/view/<?php echo $data->id; ?>" 
