<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/Retur/ttr_list'); ?>"> TTR List </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
    ...
    <div class="col-md-12"> 
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-file-text-o"></i>TTR List
                </div>                
            </div>
            <div class="portlet-body">
                ...
                <tr>
                    ...
                    <th>Type <br>Retur</th>
                    <th>Request <br>Barang</th>
                    <th>Voucher <br>Retur</th>
                    <th>Actions</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            <?php                                
                                if(($group_id==1 || $hak_akses['create_request_barang']==1) && 
                                        ($data->status_pembayaran==0 || ($data->status_pembayaran==1 && $data->type_retur==0)) && $data->ttr_id==0)
                                    {
                                    echo '<a class="btn btn-circle btn-xs green-seagreen" href="'.base_url().'index.php/Retur/create_request_barang/'.$data->id.'" 
                                        style="margin-bottom:4px"> &nbsp; <i class="fa fa-print"></i> Create &nbsp; </a> ';
                                }
                            ?>
                        </td>
                        <td style="text-align:center"> 
                            <?php                                
                                /*if($group_id==1 || $hak_akses['print_ttr']==1){
                                    echo '<a class="btn btn-circle btn-xs blue-ebonyclay" href="'.base_url().'index.php/Retur/print_ttr/'.$data->id.'" 
