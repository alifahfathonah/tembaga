                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <?php
                                if( ($group_id==1 || $hak_akses['create_voucher_dp']==1)  && $data->flag_dp==0 && $data->flag_pelunasan==0){
                        ...
                        <td style="text-align:center">
                            <?php
                                if($data->flag_pelunasan==0){
                                    if( ($group_id==1 || $hak_akses['create_voucher_pelunasan']==1)){
                        ...
                        <td style="text-align:center">
                            <?php
                                if( ($group_id==1 || $hak_akses['create_dtr']==1)  && $data->flag_dp>0 && $data->ready_to_dtr>0){
                                    echo '<a class="btn btn-circle btn-xs green-seagreen" href="'.base_url().'index.php/BeliRongsok/create_dtr/'.$data->id.'" 
                                        style="margin-bottom:4px"> &nbsp; <i class="fa fa-pencil-square-o"></i> Create &nbsp; </a>';
                                }
                            ?>
                        </td>
...
function simpanData(){
    if($.trim($("#tanggal").val()) == ""){
        ...
        $('#message').html("");
        $('.alert-danger').hide();
        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/BeliRongsok/save_voucher");
        $('#formku').submit(); 
    };
};
