            ...
            <div class="portlet-title">
                ...
                <?php
                    if( ($group_id==1)||($hak_akses['add_surat_jalan']==1) ){
                        echo '<a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="'.base_url('index.php/PengirimanAmpas/add_surat_jalan').'"> '
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            ...
                            ?>
                            <a class="btn btn-circle btn-xs blue-ebonyclay" href="<?php echo base_url(); ?>index.php/PengirimanAmpas/print_surat_jalan/<?php echo $data->id; ?>" 
