<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/Tolling/add_produksi_ampas'); ?>"> Input Produksi Ampas </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/Tolling/save_produksi_ampas'); ?>">                            
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select id="ttr_id" name="ttr_id" class="form-control myline select2me" 
                                ...
                                <?php
                                    foreach ($ttr_list as $row){
                                        echo '<option value="'.$row->id.'">'.$row->no_ttr.'</option>';
                                    }
                                ?>
                            </select>
                        </div>
