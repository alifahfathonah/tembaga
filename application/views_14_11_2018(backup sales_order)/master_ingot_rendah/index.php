<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h4 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/MasterIngotRendah'); ?>"> Data Ingot Rendah </a>
        </h4>          
    </div>
</div>
<div class="row">&nbsp;</div>
    ...
    <div class="col-md-12"> 
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-beer"></i>Data Ingot Rendah
                </div>
                <div class="tools">    
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            ...
                            ?>
                            <a href="<?php echo base_url(); ?>index.php/MasterIngotRendah/delete/<?php echo $data->id; ?>" 
...
function newData(){
    ...
    $("#myModal").find('.modal-title').text('Input Data Ingot Rendah');
...
function simpandata(){
    if($.trim($("#nama_item").val()) == ""){
        ...
        if(dsState=="Input"){
            $.ajax({
                type:"POST",
                url:'<?php echo base_url('index.php/MasterIngotRendah/cek_code'); ?>',
                ...
                success:function(result){
                    if(result=="ADA"){
                        ...
                        $('#message').html("");
                        $('.alert-danger').hide();
                        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/MasterIngotRendah/save");
                        $('#formku').submit();                    
                    }
                }
            });
        }else{
            $('#formku').attr("action", "<?php echo base_url(); ?>index.php/MasterIngotRendah/update");
            $('#formku').submit(); 
        }
    };
};
...
function editData(id){
    dsState = "Edit";
    $.ajax({
        url: "<?php echo base_url('index.php/MasterIngotRendah/edit'); ?>",
        type: "POST",
        data : {id: id},
        success: function (result){
            ...
            $("#myModal").find('.modal-title').text('Edit Data Ingot Rendah');
            $("#myModal").modal('show',{backdrop: 'true'});           
        }
    });
}
