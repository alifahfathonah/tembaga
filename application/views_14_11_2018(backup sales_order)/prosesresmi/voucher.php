  ...
  <?php
            if($this->session->userdata('group_id')==4 || $this->session->userdata('group_id')==1){
        ?>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="eventInsForm" method="post" target="_self" name="formku" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                <select name="id_app_resmi">
                                   <?php
                                        foreach($kode_barang as $dt){
                                               echo"<option value='$dt->kode_barang'>$dt->kode_barang</option>"; 
                                        }
                                   ?>
                               </select>
                                </div>
            ...
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ?>
                        <td><a href="<?php echo base_url().'index.php/ProsesResmi/request_barang/'.$data->id; ?>" >Request</a></td>
                        <?php } ?>
                    </tr>
                    <?php
                        }
