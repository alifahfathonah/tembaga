<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/Ingot/add_produksi'); ?>">  Edit Milik </a> 
        </h5>          
    </div>
</div>
   ...
   <div class="row">&nbsp;</div>
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/Mmilik/save_editmilik'); ?>"> <input type="hidden" name="id" value="<?= $detail[0]->id ?>">                           
             <div class="row">
                <div class="col-md-12">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-12">
                            <input type="text" id="milik" name="milik" 
                                class="form-control myline " style="margin-bottom:5px;float:left;" value="<?= $detail[0]->milik ?>">
                        </div>
