<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/CuciKawatHitam/view_spb'); ?>"> View Surat Permintaan Barang (SPB)</a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
...
function approveData(){
    ...
    if (r==true){
        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/CuciKawatHitam/approve_spb");    
        $('#formku').submit(); 
    }
};
...
function rejectData(){
    if($.trim($("#reject_remarks").val()) == ""){
        ...
        $('#message').html("");
        $('.alert-danger').hide();
        $('#frmReject').attr("action", "<?php echo base_url(); ?>index.php/CuciKawatHitam/reject_spb");
        $('#frmReject').submit(); 
    }
}
