<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/Retur/edit_request_barang'); ?>"> Request Barang Pengganti </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        <?php
            if( ($group_id==1)||($hak_akses['edit_request_barang']==1) ){
        ?>
        <div class="row">
            <div class="col-md-12">
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/Retur/update_request_barang'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/Retur/ttr_list'); ?>" class="btn blue-hoki"> 
...
function loadDetail(id){
    $.ajax({
        type:"POST",
        url:'<?php echo base_url('index.php/Retur/load_detail_request_barang'); ?>',
        data:"id="+ id,
...
function saveDetail(){
    if($.trim($("#rongsok_id").val()) == ""){
        $('#message').html("Silahkan pilih detail item request barang!");
        $('.alert-danger').show(); 
        ...
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/Retur/save_detail_request_barang'); ?>',
            data:{
                id:$('#id').val(),
...
function hapusDetail(id){
    var r=confirm("Anda yakin menghapus detail item request barang ini?");
    if (r==true){
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/Retur/delete_detail_request_barang'); ?>',
            data:"id="+ id,
            success:function(result){
                if(result['message_type']=="sukses"){
                    loadDetail($('#id').val());
