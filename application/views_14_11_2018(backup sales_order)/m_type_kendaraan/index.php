<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h4 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/TypeKendaraan'); ?>"> Type Kendaraan </a>
        </h4>          
    </div>
</div>
<div class="row">&nbsp;</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            ...
                            ?>
                            <a href="<?php echo base_url(); ?>index.php/TypeKendaraan/delete/<?php echo $data->id; ?>" 
...
function simpandata(){
    if($.trim($("#type_kendaraan").val()) == ""){
        ...
        if(dsState=="Input"){
            $.ajax({
                type:"POST",
                url:'<?php echo base_url('index.php/TypeKendaraan/cek_code'); ?>',
                ...
                success:function(result){
                    if(result=="ADA"){
                        ...
                        $('#message').html("");
                        $('.alert-danger').hide();
                        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/TypeKendaraan/save");
                        $('#formku').submit();                    
                    }
                }
            });
        }else{
            $('#formku').attr("action", "<?php echo base_url(); ?>index.php/TypeKendaraan/update");
            $('#formku').submit(); 
        }
    };
};
...
function editData(id){
    dsState = "Edit";
    $.ajax({
        url: "<?php echo base_url('index.php/TypeKendaraan/edit'); ?>",
        type: "POST",
        data : {id: id},
        success: function (result){
