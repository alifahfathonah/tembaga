<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/SalesOrder/add'); ?>"> Input Sales Order </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/SalesOrder/save'); ?>">                            
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <select id="jenis_barang" name="jenis_barang" data-placeholder="Silahkan pilih..."
                                   class="form-control myline select2me" style="margin-bottom:5px" required="required">
                                <option value=""></option>
                                <?php
