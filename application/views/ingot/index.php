    ...
    <div class="collapse well" id="form_filter" >
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-truck"></i>List Produksi
                </div>  
                <div class="tools">
                ...
                <?php
                    if( ($group_id==1 || $group_id == 21)||($hak_akses['add']==1) ){
                        echo '<a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="'.base_url('index.php/Ingot/add').'"> '
                        .'<i class="fa fa-plus"></i> Input Produksi </a>';
                    }
                ?>                    
                </div>
            </div>
...
function filterData(){
    var s=$('#tgl_start').val();
    var e=$('#tgl_end').val();
    window.location = '<?=base_url();?>index.php/Ingot/index/'+s+'/'+e;
}
</script>         