<html lang="en">
    ...
    <body class="margin-left:40px;">
        <p>&nbsp;</p>
        <h3 style="text-align: center; text-decoration: underline;"><?php if($this->session->userdata('user_ppn')==1){ echo 'PT. KAWATMAS PRAKASA<br>'; }?>PURCHASE ORDER SPARE PART</h3>
        <table border="0" cellpadding="2" cellspacing="0" width="900px" style="font-family:Microsoft Sans Serif">
            ...
            <tr><td colspan="3">
                    <table border="0" cellpadding="4" cellspacing="0" width="40%">
                        ...
                        <tr>
                            <td>Tanggal</td>
                            <td>: <?php echo date('d-m-Y', strtotime($header['approved'])); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
