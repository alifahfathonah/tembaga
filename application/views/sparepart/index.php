<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h4 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/Sparepart'); ?>"> Data Sparepart </a>
        </h4>          
    </div>
</div>
<div class="row">&nbsp;</div>
    ...
    <div class="col-md-12"> 
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Data Sparepart
                </div>
                <div class="tools">    
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            ...
                            ?>
                            <a href="<?php echo base_url(); ?>index.php/Sparepart/delete/<?php echo $data->id; ?>" 
...
function newData(){
    ...
    $("#myModal").find('.modal-title').text('Input Data Sparepart');
...
function simpandata(){
    if($.trim($("#nama_item").val()) == ""){
        ...
        if(dsState=="Input"){
            $.ajax({
                type:"POST",
                url:'<?php echo base_url('index.php/Sparepart/cek_code'); ?>',
                ...
                success:function(result){
                    if(result=="ADA"){
                        ...
                        $('#message').html("");
                        $('.alert-danger').hide();
                        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/Sparepart/save");
                        $('#formku').submit();                    
                    }
                }
            });
        }else{
            $('#formku').attr("action", "<?php echo base_url(); ?>index.php/Sparepart/update");
            $('#formku').submit(); 
        }
    };
};
...
function editData(id){
    dsState = "Edit";
    $.ajax({
        url: "<?php echo base_url('index.php/Sparepart/edit'); ?>",
        type: "POST",
        data : {id: id},
        success: function (result){
