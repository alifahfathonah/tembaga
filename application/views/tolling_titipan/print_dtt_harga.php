                    ...
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <?php
                            ...
                            foreach ($details as $row){
                                ...
                                echo '<td style="text-align:right; border-left:1px solid #000; border-right:1px solid #000;">'.number_format($total,2,',','.').'</td>';
                                echo '</tr>';
                                $bruto += $row->bruto;
                                $netto += $row->netto;
                                $total_harga += $total;
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td style="text-align:right; border-left:1px solid #000; border-right:1px solid #000; border-bottom:1px solid #000"><strong><?php echo number_format($total_harga,2,',', '.'); ?></strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
