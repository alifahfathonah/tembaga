                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <?php
                                if( ($group_id==1 || $hak_akses['create_dtr']==1) && $data->flag_tolling==1){
                                    echo '<a class="btn btn-circle btn-xs green-seagreen" href="'.base_url().'index.php/Tolling/matching/'.$data->id.'" 
