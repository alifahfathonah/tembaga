...
<div class="row">                            
    <div class="col-md-12"> 
        <h3 align="center"><b> Edit PO <?=$header['jenis_po'];?></b></h3>
        <hr class="divider" />
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/Tolling/update_po'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                ...
                                <th style="width: 20%">Nama Item <?=$header['jenis_po'];?></th>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    ?>
                    <a href="<?php echo base_url('index.php/Tolling/po_list'); ?>" id="btn_kembali" class="btn blue-hoki"> 
