                        ...
                        <form class="eventInsForm" method="post" target="_self" name="frmReject" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="hidden" id="jenis_barang" name="jenis_barang" value="<?php echo $header_po['jenis_po'];?>">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="portlet box yellow-gold">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-file-word-o"></i>Daftar Timbang Tolling
                        </div>                 
                    </div>
            ...
            <div class="col-md-6">
                <div class="portlet box green-seagreen">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-file-word-o"></i><span style="color: green; font-weight: bold;">Approved</span> Daftar Timbang Tolling
                        </div>                 
                    </div>
                    <div class="portlet-body">
                        <?php 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        : <div style="color:red; display: inline"><?php echo $row->no_dtt; ?></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                ...
                <div class="portlet box green-seagreen">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-file-word-o"></i>Data Timbang Tolling
                        </div>                 
                    </div>
                    <div class="portlet-body">
                        <?php 
...
function reject(id){
    var r=confirm("Anda yakin me-reject DTT ini?");
    if (r==true){
        $('#dtbj_id').val(id);
        $('#message').html("");
        $('.alert-danger').hide();
        
        $("#myModal").find('.modal-title').text('Reject DTT');
...
function rejectData(){
    if($.trim($("#reject_remarks").val()) == ""){
        ...
        $('#message').html("");
        $('.alert-danger').hide();
        $('#frmReject').attr("action", "<?php echo base_url(); ?>index.php/Tolling/reject_matching_dtt");
        $('#frmReject').submit(); 
    }
}
