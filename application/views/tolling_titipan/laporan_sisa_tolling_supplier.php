<div class="row">
   ...
   <div class="col-md-12" style="margin-top: 10px;"> 
        <h3>Laporan Sisa Tolling Supplier</h3>
        <hr class="divider">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
...
function simpanData(){
    if($.trim($("#bulan").val()) == ""){
        $('#message').html("Bulan harus dipilih, tidak boleh kosong!");
        $('.alert-danger').show();
        ...
        var b=$('#bulan').val();
        var t=$('#tahun').val();
        window.open('<?php echo base_url();?>index.php/Tolling/print_sisa_tolling_supplier?b='+b+'&t='+t,'_blank');
    };
}
</script>
