                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="jenis_barang" name="jenis_barang" 
                                        ...
                                        readonly="readonly" value="Tolling Customer">

                                    <input type="hidden" id="jenis_laporan" name="jenis_laporan" value="1"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">
                                    ...
                                    <a class="btn btn-circle btn-xs red" href="<?php echo base_url(); ?>index.php/Tolling/delete_stok/<?php echo $data->id;?>/1" onclick="return confirm('Anda yakin menghapus transaksi ini?');" style="margin-bottom:4px"> &nbsp; <i class="fa  fa-trash"></i> Hapus &nbsp; </a>
                                </td>
                            </tr>
                            <?php
                                }
...
function simpanData(){
    if($.trim($("#laporan").val()) == ""){
        ...
        var s=$('#tgl_start').val();
        var e=$('#tgl_end').val();
        window.open('<?php echo base_url();?>index.php/Tolling/print_laporan_tolling_so?l='+l+'&ts='+s+'&te='+e,'_blank');
    };
}
