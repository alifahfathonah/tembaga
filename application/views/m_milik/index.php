    ...
    <div class="col-md-12"> 
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                ...
                <div class="tools">        
                    <a style="height:28px" class="btn btn-circle btn-sm default" href="<?= base_url(); ?>index.php/Mmilik/add">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:200px; text-align:center"> 
                            ...
                            ?>
                            <a class="btn btn-circle btn-xs green" href="<?= base_url();?>index.php/Mmilik/edit/<?= $data->id; ?>" style="margin-bottom:4px">
