    ...
    <div class="collapse well" id="form_tanggal" >
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                ...
                ?>
                <a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="<?=base_url();?>index.php/Finance/add"> <i class="fa fa-plus"></i> Input Kas Masuk</a>
                <?php } ?>
                </div>               
            </div>
...
function filterTgl(){
    var s=$('#tgl_start').val();
    var e=$('#tgl_end').val();
    window.location = '<?=base_url();?>index.php/Finance/index/'+s+'/'+e;
}
function filterData(){
    var id=$('#customer').val();
