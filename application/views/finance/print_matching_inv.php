            ...
            <tr><td colspan="3">
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td rowspan="2" style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>Jumlah Invoice</strong></td>
                            <td rowspan="2" style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>Biaya 1</strong></td>
                            <td rowspan="2" style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>Biaya 2</strong></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; border-left:1px solid #000;"><?=number_format($harga_total,0,',','.');?></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; border-left:1px solid #000; border-bottom:1px solid #000">
                                <strong><?=number_format($total_invoice,0,',','.');?></strong>
                            </td>
                ...
                <td colspan="3">
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>Jenis<br>Pembayaran</strong></td>
                            <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>Bank<br>Pembayaran</strong></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000;"><?=$row->no_uang_masuk;?></td>
                            <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000;"><?=$row->jenis_pembayaran;?></td>
                            <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000;"><?=$row->bank_pembayaran;?></td>
                            <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-right:1px solid #000;"><?=number_format($row->nominal,0,',','.');?></td>
                        </tr>
