      ...
      <table width="100%" style="page-break-after: auto;">
        <tr>
          <td align="center">
            ...
            <h4>Rekap Penjualan KKH per Item<br>Per Tanggal : <?php echo " <i>".tanggal_indo(date("Y-m-d", strtotime($_GET['ts']))).' s/d '.tanggal_indo(date("Y-m-d", strtotime($_GET['te'])))."</i>";?></h4>
          </td>
        </tr>
      </table>
      <table width="100%" cellpadding="2" cellspacing="0">
        <thead>
           <tr>
                ...
                <th style="text-align: center; border-top: 1px solid; border-left: 1px solid;">Nilai</th>
