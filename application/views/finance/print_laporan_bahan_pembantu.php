	...
	<table width="100%" cellspacing="0" cellpadding="2" style="border-collapse: collapse;" border="1">
		<thead>
			<tr>
				...
				<th style="text-align: center;" colspan="2">Stock Awal</th>
				<th style="text-align: center;" colspan="2">Pemasukan</th>
				<th style="text-align: center;" colspan="2">Pemakaian</th>
		...
		<?php
			...
			echo 
				"<tr>
					...
					<td align='right'><b>".number_format($grand_total_saldo_amount,2,'.',',')."</b></td>
					<td align='right'><b>"./*number_format($grand_total_qty_masuk,2,'.',',').*/"</b></td>
					<td align='right'><b>".number_format($grand_total_amount_masuk,2,'.',',')."</b></td>
					<td align='right'><b>"./*number_format($grand_total_qty_keluar,2,'.',',').*/"</b></td>
					<td align='right'><b>".number_format($grand_total_amount_keluar,2,'.',',')."</b></td>
					<td align='right'><b>"./*number_format($grand_total_qty_sisa,2,'.',',').*/"</b></td>
					<td align='right'><b>".number_format($grand_total_amount_sisa,2,'.',',')."</b></td>
				</tr>
				<tr>
					<td colspan='12'>&nbsp;</td>
				</tr>";
