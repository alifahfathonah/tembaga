<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/Finance/index'); ?>">Rangking Pemasukan Rongsok</a> 
        </h5>          
    </div>
</div>
   ...
   <div class="col-md-12" style="margin-top: 10px;"> 
        <h3>Rangking Pemasukan Rongsok</h3>
        <hr class="divider">
        <div class="row">
                <div class="col-md-6">
                    <div class="row">
...
function simpanData(){
    if($.trim($("#tgl_start").val()) == ""){
        ...
        var s=$('#tgl_start').val();
        var e=$('#tgl_end').val();
        window.open('<?php echo base_url();?>index.php/Finance/print_rangking_rongsok?laporan='+l+'&ts='+s+'&te='+e,'_blank');
    };
};
</script>
