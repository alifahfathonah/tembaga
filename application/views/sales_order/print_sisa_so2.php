 ...
 /*           $total_amount = $row->netto * $row->amount;  */
        ...
        if($last_series!=$row->nama_customer && $last_series!=null){
          echo '<tr>
            ...
            <td colspan="5" style="text-align: right; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000; "><strong>Total</strong></td>
        ...
        ?>
          ...
          <tr>
            <td colspan="7" style="text-align: right; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000; "><strong>Grand Total</strong></td>
