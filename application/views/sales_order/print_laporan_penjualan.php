 ...
 /*           $total_amount = $row->netto * $row->amount;  */
              if($last_series != $row->kode_customer && $last_series != null){
                echo '<tr>
                    ...
                    <td align="right" style="border-top: 2px solid;border-bottom:1px solid; border-left: 1px solid;">'.number_format($ntc,2,',','.').'</td>
              ...
              if($last_tolling != $row->flag_tolling && $last_tolling != null){
                echo '<tr>
                    ...
                    <td align="right" style="border-top: 2px solid;border-bottom:1px solid; border-left: 1px solid;">'.number_format($nm,2,',','.').'</td>
        ...
        <?php 
          ...
          <tr>
            ...
            <td align="right" style="border-top: 5px solid;border-bottom:1px solid; border-left: 1px solid;"><?=number_format($nilai_materai,2,',','.');?></td>
