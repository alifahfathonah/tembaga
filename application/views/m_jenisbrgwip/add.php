<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/Ingot/add_produksi'); ?>">  Add Jenis Barang Wip </a> 
        </h5>          
    </div>
</div>
   ...
   <div class="row">&nbsp;</div>
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/Mjenisbrgwip/save_addjenisbrgwip'); ?>">                            
             <div class="row">
                <div class="col-md-12">
