<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/R_Rongsok/edit'); ?>"> Edit PO Rongsok </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <?php
            if( ($group_id==16)||($hak_akses['edit']==1) ){
        ?>
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/R_Rongsok/update'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                        if( ($group_id==16)||($hak_akses['close_po']==1) ){
