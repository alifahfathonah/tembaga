<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h4 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/R_Rongsok'); ?>"><i class="fa fa-angle-right"></i> Rongsok</a>
...
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/R_Rongsok/save_dtr'); ?>">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="no_dtr" name="no_dtr" 
