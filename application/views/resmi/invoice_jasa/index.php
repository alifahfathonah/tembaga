...
function filterData(){
    ...
    <?php if($this->uri->segment(3)=='Customer'){
        echo "window.location = '".base_url()."index.php/R_InvoiceJasa/index/Customer/'+s+'/'+e;";
    }elseif($this->uri->segment(3)=='Supplier'){
        echo "window.location = '".base_url()."index.php/R_InvoiceJasa/index/Supplier/'+s+'/'+e;";
    }else{
        echo "window.location = '".base_url()."index.php/R_InvoiceJasa/index/'+s+'/'+e;";
    }?>
}
</script>