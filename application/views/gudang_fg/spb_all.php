<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/GUdangFG/spb_all'); ?>"> SPB ALL List </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
    ...
    <div class="col-md-12"> 
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                ...
                <div class="tools">
                    <a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="<?php echo base_url('index.php/GudangFG/add_spb_all');?>"><i class="fa fa-plus"></i> Request Barang </a>
                </div>
            </div>
