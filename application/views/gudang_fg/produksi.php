        ...
        <tr>
            ...
            <td> 
                ...
                if(($group_id==1 && !$data->flag_result) || (!$data->flag_result)){
                    echo '<a class="btn btn-circle btn-xs blue" href="'.base_url().'index.php/GudangFG/edit_laporan/'.$data->id.'" style="margin-bottom:4px"> &nbsp; <i class="fa fa-edit"></i> Edit &nbsp; </a> ';
                }else{
                   echo '<a class="btn btn-circle btn-xs blue-ebonyclay" href="'.base_url().'index.php/GudangFG/edit_laporan/'.$data->id.'" style="margin-bottom:4px"> &nbsp; <i class="fa fa-book"></i> View &nbsp; </a> ';
                }
                ?>
            </td>
        </tr>    
