      ...
      <table width="100%" cellpadding="3" cellspacing="0" style="font-size: 10px;">
        <thead>
           <tr>
                ...
                <th style="text-align: center; border-top: 1px solid; border-left: 1px solid;">Stok Terima</th>
                ...
                <th style="text-align: center; border-top: 1px solid; border-left: 1px solid;">Stok Akhir</th>
 ...
 /*           $total_amount = $row->netto * $row->amount;  */
            ...
            if($last_series != $row->nama_customer && $last_series != null){
              echo '<tr>
                  ...
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid;">'.number_format($stok_terima,2,',','.').'</td>
                  ...
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid; border-right: 1px solid;">'.number_format($stok_akhir,2,',','.').'</td>
        ...
        $potong_qty_s = 0;
          ...
          if($row->jenis_retur==1 && $row->tanggal_invoice != $start){
        ...
        ?>
            <tr>
              ...
              <td align="right" style="border-top: 1px solid; border-left: 1px solid;"><?=($row->tanggal<$start)? number_format($row->netto-$row->netto_kirim_b,2):'-' ?></td>
              <td align="right" style="border-top: 1px solid; border-left: 1px solid;"><?=($row->tanggal>=$start)? number_format($row->netto,2):'-' ?></td>
              <td align="right" style="border-top: 1px solid; border-left: 1px solid;"><?=($row->jenis_retur==0)? number_format($row->netto_kirim,2): '-';?></td>
              <td align="right" style="border-top: 1px solid; border-left: 1px solid;"><?=($row->jenis_retur==1&&$row->tanggal_invoice != $start)? number_format($row->netto_kirim,2): '-';?></td>
        ...
        <?php $no++;
          ...
          $last_series2 = $row->no_retur;
            ...
            echo '<tr>
                  ...
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid; border-right: 1px solid;">'.number_format($kirim_qty,2,',','.').'</td>
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid; border-right: 1px solid;">'.number_format($potong_qty,2,',','.').'</td>
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid;">'.number_format($stok_akhir,2,',','.').'</td>
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid; border-right: 1px solid;"></td>
                </tr>';
            echo '<tr>
                  <td colspan="6" style="text-align: right; border-top: 2px solid;border-bottom:1px solid;border-left: 1px solid;"><strong>Total</strong></td>
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid;">'.number_format($t_stok_awal,2,',','.').'</td>
                  <td align="right" style="border-top: 2px solid;border-bottom:4px solid; border-left: 1px solid;">'.number_format($t_stok_terima,2,',','.').'</td>
