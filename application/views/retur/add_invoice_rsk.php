                        ...
                        <table class="table table-bordered table-striped table-hover" id="tabel_barang">
                            ...
                            <tbody id="boxDetail">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo '<input type="text" class="form-control myline" style="margin-bottom:5px" name="details['.$no.'][nama_barang]" value="'.$row->nama_item.'" readonly="readonly"><input type="hidden" name="details['.$no.'][jenis_barang_id]" value="'.$row->jenis_barang_id.'">';?></td>
