<html lang="en">
    ...
    <body class="margin-left:40px;">
        <p>&nbsp;</p>
        <h3 style="text-align: center; text-decoration: underline;"><?php if($this->session->userdata('user_ppn')==1){ echo 'PT. KAWATMAS PRAKASA<br>'; }?>BANK KELUAR PEMBELIAN SPARE PART</h3>
            ...
            <tr><td colspan="3">
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td rowspan="2" style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>Nomor LPB</strong></td>
                        ...
                        <tr>
                            ...
                            <td style="border-left:1px solid #000;"><?=$row->no_bpb;?></td>
                            <td style="border-left:1px solid #000;"><?=$row->no_po;?></td>
                            <td style="text-align:right; border-left:1px solid #000;"><?=$row->remarks;?></td>
