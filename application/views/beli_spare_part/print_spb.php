<html lang="en">
    ...
    <body class="margin-left:40px;">
        <p>&nbsp;</p>
        <h3 style="text-align: center; text-decoration: underline;"><?php if($this->session->userdata('user_ppn')==1){ echo 'PT. KAWAT MAS PRAKASA<br>'; }?>SURAT PERMINTAAN BARANG SPARE PART</h3>
                    ...
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <?php
                            ...
                            foreach ($details as $row){
                                ...
                                echo '<td style="border-left:1px solid #000">'.number_format($row->qty,2,',','.').'</td>';
