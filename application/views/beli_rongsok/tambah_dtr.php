                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-striped table-hover" id="tabel_dtr">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="name_rongsok_1" name="myDetails[1][nama_item]" class="form-control select2me myline" data-placeholder="Pilih..." style="margin-bottom:5px" onclick="get_uom_po(this.value,1);">
                                        <option value=""></option>
...
<!--                                 <td><input type="text" id="qty_1" name="myDetails[1][qty]" class="form-control myline" value="0" maxlength="10" onkeydown="return myCurrency(event);" onkeyup="getComa(this.value, this.id);"></td> -->
                                ...
                                <td><a href="javascript:;" class="btn btn-xs btn-circle green-seagreen" style="margin-bottom: 5px;" onclick="timbang_netto_manual(1);"> <i class="fa fa-dashboard"></i> Manual </a>
                                <a href="javascript:;" class="btn btn-xs btn-circle green-seagreen" onclick="timbang_netto(1);"> <i class="fa fa-dashboard"></i> Auto </a></td>                          
...
<script>
function timbang_netto_manual(id){
...
function timbang_netto(id){
    $.ajax({
        url: "http://192.168.0.203:10000/scaleload",
        method: "POST",
        dataType: "json",
        success: function (result){
    ...
    if($.trim($("#name_rongsok_"+id).val()) == ""){
        ...
        $("#tabel_dtr>tbody").append(
            '<tr>'+
                ...
                '<td><a href="javascript:;" class="btn btn-xs btn-circle green-seagreen" onclick="timbang_netto_manual('+new_id+');" style="margin-bottom: 5px;"> <i class="fa fa-dashboard"></i> Manual </a>'+
                '<a href="javascript:;" class="btn btn-xs btn-circle green-seagreen" onclick="timbang_netto('+new_id+');"> <i class="fa fa-dashboard"></i> Auto </a>'+
                '</td>'+
