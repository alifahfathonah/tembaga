<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h4 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/Spbwip'); ?>"> Spb Fg </a>
        </h4>          
    </div>
</div>
<div class="row">&nbsp;</div>
   ...
   <div class="col-md-12" style="margin-top: 10px;"> 
    <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-beer"></i> SPB FG 
                </div>             

                 <div class="tools">    
            
                    
                    <a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="<?=base_url('index.php/Spbfg/add')?>"> 
                        <i class="fa fa-plus"></i> Add Spb Fg  </a>
