<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/PengirimanAmpas/bpb_list'); ?>"> BPB List </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
        ...
        <div class="portlet box yellow-gold">
            ...
            <div class="portlet-body">
                ...
                <tr>
                    ...
                    <th style="text-align: center;">Jumlah <br>Items</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            <?php
                                if($group_id==1 || $hak_akses['view_bpb']==1){
                            ?>
                            <a class="btn btn-circle btn-xs blue" href="<?php echo base_url(); ?>index.php/PengirimanAmpas/view_bpb/<?php echo $data->id; ?>" 
                               style="margin-bottom:4px"> &nbsp; <i class="fa  fa-file-text-o"></i> View &nbsp; </a>
                               <?php
                                }?>
                            <?php                                                                
                                if($group_id==1 || $hak_akses['print_bpb']==1){
                                    echo '<a class="btn btn-circle btn-xs blue-ebonyclay" href="'.base_url().'index.php/PengirimanAmpas/print_bpb/'.$data->id.'" 
