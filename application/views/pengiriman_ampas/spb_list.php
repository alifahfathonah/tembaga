<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/PengirimanAmpas/spb_list'); ?>"> SPB Ampas List </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
    ...
    <div class="col-md-12"> 
        ...
        <div class="portlet box yellow-gold">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-file-word-o"></i>SPB Ampas List
                </div> 
                <div class="tools">    
                <a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="<?=base_url();?>index.php/PengirimanAmpas/add_spb"> <i class="fa fa-plus"></i> Ajukan SPB Ampas</a>              
                </div>               
            </div>
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="background-color: "><?php echo $data->no_spb_ampas; ?></td>
                        ...
                        <td style="text-align:center"> 
                            ...
                            ?>
                            <a class="btn btn-circle btn-xs blue" href="<?php echo base_url(); ?>index.php/PengirimanAmpas/view_spb/<?php echo $data->id; ?>" 
                            ...
                            ?>
                            <a class="btn btn-circle btn-xs blue-ebonyclay" href="<?php echo base_url(); ?>index.php/PengirimanAmpas/print_barcode/<?php echo $data->id; ?>" 
                            ...
                            <?php   
                                ...
                                if($group_id==1 || $hak_akses['print_spb']==1){
                                    echo '<a class="btn btn-circle btn-xs blue-ebonyclay" href="'.base_url().'index.php/PengirimanAmpas/print_spb/'.$data->id.'" 
