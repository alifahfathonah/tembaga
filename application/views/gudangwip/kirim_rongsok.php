<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/GudangWIP/spb_kirim_rongsok'); ?>"> SPB Kirim WIP Ke Rongsok </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        <?php
            if( ($group_id==1 || $group_id==21)||($hak_akses['spb_kirim_rongsok']==1) ){
        ?>
        <div class="row">
            <div class="col-md-12">
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/GudangWIP/save_spb_kirim_rongsok'); ?>">                            
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <textarea id="remarks" name="remarks" rows="2" readonly="readonly"
                                class="form-control myline" style="margin-bottom:5px">BARANG WIP TRANSFER KE RONGSOK</textarea>                           
                        </div>
                    </div>
                </div>              
            </div>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody id="boxDetail">
                                <tr>
                                    ...
                                    <td><?=$barang['qty'];?><input type="hidden" name="qty" value="<?=$barang['id'];?>"></td>
                                    <td><?=$barang['berat'];?><input type="hidden" name="berat" value="<?=$barang['id'];?>"></td>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/GudangWIP'); ?>" class="btn blue-hoki"> 
