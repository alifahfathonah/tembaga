	...
	<table width="100%" cellpadding="2" cellspacing="0" style="font-size: 13px;">
		<thead>
			<tr>
                ...
                <th style="border-top: 1px solid; border-bottom: 1px solid; width: 20%;">Keterangan</th>
				...
				if ($last_series != '') {
					if ($last_series != $row->kode) {
						...
						if ($last_sumber == $row->sumber) {
							echo 
								"<tr>
									<td colspan='9'><b><u>".$row->kode."</u></b></td>
								</tr>";
						} else {
							$last_series = '';
						}							
