...
<table width="100%" cellpadding="0" cellspacing="0" style="border-left: 1px solid #000; border-bottom: 1px solid #000; border-right: 1px solid #000;">
    <tr>
        <td>
            <table border="0" cellpadding="4" cellspacing="0" width="100%" style="font-size:12px;">
                ...
                <tr>
                    ...
                    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>KG</strong></td>
                    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-top:1px solid #000;"><strong>%</strong></td>
                    <td style="text-align:center; border-left:1px solid #000; border-bottom:1px solid #000; border-right:1px solid #000; border-top:1px solid #000; border-left:1px solid #000;"><strong>(M<sup>3</sup>)</strong></td>
                </tr>
<?php
    $no = 0;
    $berat_rongsok = 0;
    ...
    foreach ($detailLaporan as $row){
        $persen_hasil = (($row->berat_ingot/$row->total_rongsok)*100);
        $persen_bs_ingot = (($row->bs_service/$row->total_rongsok)*100);
        $persen_bs_apl = (($row->bs/$row->total_rongsok)*100);
        $susut = $row->total_rongsok-$row->berat_ingot-$row->bs-$row->bs_service;
        $persen_susut_apl = (($susut/$row->total_rongsok)*100);
        $no++;
        echo '<tr>';
        ...
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.number_format($persen_hasil,2,',','.').'</td>';
        ...
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.number_format($persen_bs_ingot,2,',','.').'</td>';
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.number_format($row->bs,2,',','.').'</td>';
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.number_format($persen_bs_apl,2,',','.').'</td>';
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.number_format($susut,2,',','.').'</td>';
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.number_format($persen_susut_apl,2,',','.').'</td>';
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">-</td>';
    ...
    ?>
                ...
                <tr>
                    <td style="border-bottom:1px solid #000;  border-right:1px solid #000; text-align: center;" colspan="18">
        ...
        <td rowspan="2">
            <table border="0" cellpadding="4" cellspacing="0" width="100%" style="font-size:12px;">
                <tr>
                    <td style="height: 50px;text-align:center; border-bottom:1px solid #000; border-top:1px solid #000; border-right:1px solid #000;"><strong><br>KETERANGAN</strong></td>
                </tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px;">
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000"></td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Prosentasi</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Hasil :
                        <?=number_format($hasil,2,',','.');?>%</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">BS :
                        <?=number_format($all_bs,2,',','.');?>%</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Susut :
                        <?=number_format($hasil_susut,2,',','.');?>%</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Susut di Pot. 25% :</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Rata-rata pemakaian bahan baku/bulan</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Rata-rata BS/bln</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000;">Rata-rata Susut/bln</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Rata-rata Pemakaian Bahan Bakar Gas<br>M<sup>3</sup>/Kg = M<sup>3</sup></td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">M<sup>3</sup>/Ton = M<sup>3</sup></td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr style="font-size: 10px;">
                    <td style="padding-left: 3px; border-right:1px solid #000">SUSUT = KG (25%)</td>
                </tr>
                <tr style="text-align: right;">
                    <td style="padding-left: 3px; border-right:1px solid #000;"><?=number_format($berat_susut,2,',','.');?><br><?=number_format($berat_susut*25/100,2,',','.');?></td>
                </tr>
            </table>
        </td>
    </tr>
