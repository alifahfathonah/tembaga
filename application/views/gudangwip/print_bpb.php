<html lang="en">
    ...
    <body class="margin-left:40px;">
        <p>&nbsp;</p>
        <h3 style="text-align: center; text-decoration: underline;"><?php if($this->session->userdata('user_ppn')==1){ echo 'PT. KAWAT MAS PRAKASA<br>'; }?>BUKTI PENERIMAAN BARANG WIP</h3>
            ...
            <tr><td colspan="3">
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; border-left: 1px solid #000; border-bottom: 1px solid #000;"><?=number_format($netto,2,',', '.');?></td>
