<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/GudangWIP/add_gudang_keras'); ?>"> Tambah Gudang Keras </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/GudangWIP/save_gudang_keras'); ?>">                            
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="qty" placeholder="Silahkan isi quantity..." name="qty" class="form-control myline" style="margin-bottom:5px" value="">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="netto" placeholder="Silahkan isi Netto..." name="netto" class="form-control myline" style="margin-bottom:5px" value="">
                        </div>
                    </div>
                    <div class="row">&nbsp;</div>
                    <div class="row">
