    ...
    ?>
        ...
        <td rowspan="2">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px;">
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">
                        <?=$no;?> HARI =
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Rata-rata pemakaian bahan baku/harian</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Rata-rata BS/hari</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000;">Rata-rata Susut/hari</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">
                ...
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">Rata-rata Pemakaian=F.K<br>M<sup>3</sup>/Kg = M<sup>3</sup></td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; text-align: right;border-right:1px solid #000">&nbsp;</td>
                </tr>
                <tr>
                    <td style="padding-left: 3px; border-right:1px solid #000">M<sup>3</sup>/Ton = M<sup>3</sup></td>
                </tr>
