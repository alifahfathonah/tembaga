<html lang="en">
    ...
    <body class="margin-left:40px;">
        <p>&nbsp;</p>
        <h3 style="text-align: center; text-decoration: underline;">PT. KAWAT MAS PRAKASA<br>SURAT PERMINTAAN BARANG WIP</h3>
        <table border="0" cellpadding="2" cellspacing="0" width="900px" style="font-family:Microsoft Sans Serif">
            ...
            <tr><td colspan="3">
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td colspan="3"></td>
                            <td style="border-left:1px solid #000; border-bottom:1px solid #000"><?=number_format($qty,0,',','.');?></td>
