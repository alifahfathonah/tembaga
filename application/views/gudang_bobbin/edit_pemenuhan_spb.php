...
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/GudangBobbin/update_pemenuhan_spb'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <table class="table table-bordered table-striped table-hover" id="tabel_bobbin">
                            ...
                            <tbody id="boxDetail">
                                ...
                                foreach ($list_barang as $value) {
                                    ...
                                    echo '<td><a class="btn btn-xs btn-circle red" href="'.base_url().'index.php/GudangBobbin/delete_detail_pemenuhan_spb/'.$header['id'].'/'.$value->id.'" style="margin-top:5px" onclick="return confirm(\'Anda yakin menghapus transaksi ini?\');"><i class="fa fa-trash"></i> Delete </a></td>';
                                    $no++;
                                }
                                ?>
                                </tr>
