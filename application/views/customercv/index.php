<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h4 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/CustomerCV'); ?>"> Data Customer CV</a>
        </h4>          
    </div>
</div>
<div class="row">&nbsp;</div>
...
function simpandata(){
     if($.trim($("#kode_customer").val()) == ""){
        ...
        $('.alert-danger').hide();
        if(dsState=="Input"){                                   
            $('#formku').attr("action", "<?php echo base_url(); ?>index.php/CustomerCV/save");                                               
        }else{
            $('#formku').attr("action", "<?php echo base_url(); ?>index.php/CustomerCV/update");
        }
        $('#formku').submit();  
    };
};
...
function editData(id){
    dsState = "Edit";
    $.ajax({
        url: "<?php echo base_url('index.php/CustomerCV/edit'); ?>",
        type: "POST",
        data : {id: id},
...
function get_city_list(id){
    $.ajax({
        url: "<?php echo base_url('index.php/CustomerCV/get_city_list'); ?>",
        async: false,
        type: "POST",
        data: "id="+id,
        dataType: "html",
