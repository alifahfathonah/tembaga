<html lang="en">
    ...
    <body class="margin-left:40px;">
        <p>&nbsp;</p>
        <h3 style="text-align: center; text-decoration: underline;"><?php if($this->session->userdata('user_ppn')==1){ echo 'PT. KAWATMAS PRAKASA<br>'; }?>PURCHASE ORDER WIP</h3>
                    ...
                    <table border="0" cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <?php
                            ...
                            foreach ($details as $row){
                                ...
                                echo '<td style="text-align:center; border-left:1px solid #000">'.$row->uom.'</td>';
