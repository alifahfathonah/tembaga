<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/RollingKawatHitam'); ?>"> Permintaan Barang (SPB) </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
            ...
            <div class="portlet-title">
                ...
                <?php
                    if( ($group_id==1)||($hak_akses['add']==1) ){
                        echo '<a style="height:28px" class="btn btn-circle btn-sm blue-ebonyclay" href="'.base_url('index.php/RollingKawatHitam/add').'"> '
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">                             
                            <?php
                                if( ($group_id==1 || $hak_akses['create_skb']==1) && $data->ready_to_skb>0 && $data->status==1){
                                    echo '<a class="btn btn-circle btn-xs green-seagreen" href="'.base_url().'index.php/RollingKawatHitam/create_skb/'.$data->id.'" 
                        ...
                        <td style="text-align:center"> 
                            ...
                            ?>
                            <a class="btn btn-circle btn-xs green" href="<?php echo base_url(); ?>index.php/RollingKawatHitam/edit/<?php echo $data->id; ?>" 
                               style="margin-bottom:4px"> &nbsp; <i class="fa  fa-pencil"></i> Edit &nbsp; </a>
                            <?php
                                }
                                if($group_id==1 || $hak_akses['view_spb']==1){
                            ?>
                            <a class="btn btn-circle btn-xs blue-ebonyclay" href="<?php echo base_url(); ?>index.php/RollingKawatHitam/view_spb/<?php echo $data->id; ?>" 
                               style="margin-bottom:4px"> &nbsp; <i class="fa  fa-file-text-o"></i> View &nbsp; </a>
                            <?php   
                                }
                                if($group_id==1 || $hak_akses['print_spb']==1){
                                    echo '<a class="btn btn-circle btn-xs blue-ebonyclay" href="'.base_url().'index.php/RollingKawatHitam/print_spb/'.$data->id.'" 
