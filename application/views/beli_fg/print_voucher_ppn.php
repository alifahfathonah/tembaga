<html lang="en">
    ...
    <body class="margin-left:40px;">
        <h3 style="text-align: center; text-decoration: underline;"><?php if($this->session->userdata('user_ppn')==1){ echo 'PT. KAWATMAS PRAKASA<br>'; }?><?php echo ($header['id_bank'] > 3) ? 'BANK' : 'KAS';?> KELUAR PEMBELIAN FINISH GOOD</h3>
