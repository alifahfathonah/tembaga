                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <?php
                                ...
                                foreach ($details as $row){
                                    ...
                                    echo '<td><input type="text" id="bruto'.$no.'" name="myDetails['.$no.'][bruto]" '
                                    ...
                                    echo '<td><input type="text" id="berat_bobbin'.$no.'" name="myDetails['.$no.'][berat_bobbin]" '
                                            . 'class="form-control myline" maxlength="10" value="'.$row->berat_bobbin.'" '
                                            . 'onkeydown="return myCurrency(event);" onkeyup="getComa(this.value, this.id);" readonly></td>';

                                    echo '<td><input type="text" id="netto'.$no.'" name="myDetails['.$no.'][netto]" '
                                    ...
                                    echo '<td><input type="text" name="myDetails['.$no.'][no_bobbin]" '
                                            . 'class="form-control myline" value="'.$row->no_bobbin.'" '
                                            . 'readonly="readonly"></td>';    

                                    echo '<td><input type="text" name="myDetails['.$no.'][no_packing]" '
                                            . 'class="form-control myline" value="'.$row->no_packing.'" '
                                            . 'readonly="readonly"></td>';    
