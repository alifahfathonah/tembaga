                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"> 
                            <a class="btn btn-circle btn-xs blue" style="margin-bottom:4px" href="<?php echo base_url(); ?>index.php/VoucherCost/edit_uk/<?php echo $data->id; ?>/KK">
...
function filterData(){
    var s=$('#tgl_start').val();
    var e=$('#tgl_end').val();
    window.location = '<?=base_url();?>index.php/VoucherCost/kas_keluar/'+s+'/'+e;
}
</script>     