<div class="row">
   ...
   <div class="col-md-12" style="margin-top: 10px;"> 
        <h3>Laporan Gudang Rongsok per Tanggal</h3>
        <hr class="divider">
        <div class="row">
                <div class="col-md-6">
                    <div class="row">
...
function simpanData(){
    if($.trim($("#tgl").val()) == ""){
        ...
        var l=$('#rongsok_id').val();
        var s=$('#tgl').val();
        window.open('<?php echo base_url();?>index.php/GudangRongsok/print_gdrsk_per_tanggal?t='+s+'&r='+l,'_blank');
    };
};
</script>
