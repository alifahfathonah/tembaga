...
<table width="100%" class="table table-striped table-bordered table-hover" id="sample_6">
    ...
    foreach ($detailLaporan as $row){
        ...
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.(($row->produksi==0)? '-':number_format($row->produksi,2,',','.')).'</td>';
        ...
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.(($row->produksi_k==0)? '-':number_format($row->produksi_k,2,',','.')).'</td>';
        ...
        echo '<td style="border-bottom:1px solid #000; border-left:1px solid #000">'.(($row->stok_fisik==0)? '-':number_format($row->stok_fisik,2,',','.')).'</td>';
    ...
    <tr>
        ...
        <td style="border-bottom:1px solid #000; border-left:1px solid #000"><strong><?=number_format($produksi_k,2,',','.');?></strong></td>
        ...
        <td style="border-bottom:1px solid #000; border-left:1px solid #000"><strong><?=number_format($stok_fisik,2,',','.');?></strong></td>
        <td style="border-bottom:1px solid #000; border-left:1px solid #000"><strong><?=number_format($total_selisih,2,',','.');?></strong></td>
