<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/IngotRendah/create_ttr'); ?>"> Create Tanda Terima Rongsok (DTR) </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12">
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/IngotRendah/save_ttr'); ?>">  
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo base_url('index.php/IngotRendah/dtr_list'); ?>" class="btn blue-hoki"> 
...
function simpanData(){
    ...
    if($.trim($("#tanggal").val()) == ""){
        ...
        if(item_check==0){
            $('#message').html("Silahkan pilih item ingot yang akan di-create TTR!"); 
            $('.alert-danger').show(); 
        }else{
            $('#message').html("");
            $('.alert-danger').hide(); 
