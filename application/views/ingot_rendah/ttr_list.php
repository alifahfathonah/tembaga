<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/IngotRendah/ttr_list'); ?>"> TTR List </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="eventInsForm" method="post" target="_self" name="formku" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <input type="text" id="jenis_barang" name="jenis_barang" 
                                        class="form-control myline" style="margin-bottom:5px" 
                                        readonly="readonly" value="INGOT RENDAH">                                                                       
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-5">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    Jumlah/ Amount (Rp) <font color="#f00">*</font>
                                </div>
                                <div class="col-md-7">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <?php
                                if( ($group_id==1 || $hak_akses['create_voucher_pembayaran']==1)  && $data->flag_bayar==0){
                        ...
                        <td style="text-align:center"> 
                            <?php                                
                                if($group_id==1 || $hak_akses['print_ttr']==1){
                                    echo '<a class="btn btn-circle btn-xs blue-ebonyclay" href="'.base_url().'index.php/IngotRendah/print_ttr/'.$data->id.'" 
...
function createVoucher(id){
    $.ajax({
        url: "<?php echo base_url('index.php/IngotRendah/create_voucher_piutang'); ?>",
        type: "POST",
        data : {id: id},
        success: function (result){
            ...
            $("#myModal").find('.modal-title').text('Create Voucher Piutang');
...
function simpanData(){
    if($.trim($("#tanggal").val()) == ""){
        ...
        $('#message').html("");
        $('.alert-danger').hide();
        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/IngotRendah/save_voucher_piutang");
        $('#formku').submit(); 
    };
};
</script>
