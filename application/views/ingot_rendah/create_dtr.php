<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/IngotRendah/create_dtr'); ?>"> Create Data Timbang Rongsok (DTR) </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12">
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/IngotRendah/save_dtr'); ?>">  
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                ...
                                <th style="width:60px">Jumlah <br>Batang</th>
                                <th>Bruto (Kg)</th>
                                <th>Netto (Kg)</th>
                                <th></th>
                                <th>No. Batch</th>
                            ...
                            <?php
                                ...
                                foreach ($details as $row){
                                    ...
                                    echo '<td><input type="text" name="myDetails['.$no.'][no_batch]" '
...
function simpanData(){
    ...
    if($.trim($("#tanggal").val()) == ""){
        ...
        if(item_check==0){
            $('#message').html("Silahkan pilih item ingot yang akan di-create DTR!"); 
            $('.alert-danger').show(); 
        }else{
            $('#message').html("");
            $('.alert-danger').hide(); 
