            ...
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <?php
                                if( ($group_id==1 || $hak_akses['create_ttr']==1) && $data->ready_to_ttr>0 && $data->status==1){
                                    echo '<a class="btn btn-circle btn-xs green-seagreen" href="'.base_url().'index.php/Tolling/create_ttr/'.$data->id.'" 
