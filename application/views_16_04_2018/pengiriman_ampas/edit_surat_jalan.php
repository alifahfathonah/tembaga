<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/PengirimanAmpas/surat_jalan'); ?>"> Surat Jalan </a> 
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/PengirimanAmpas/edit_surat_jalan'); ?>"> Edit Surat Jalan </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/PengirimanAmpas/update_surat_jalan'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            No. Purchase Order (PO) <font color="#f00">*</font>
                        </div>
                        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/PengirimanAmpas/surat_jalan'); ?>" class="btn blue-hoki"> 
...
function simpanData(){
    if($.trim($("#tanggal").val()) == ""){
        ...
        $('#message').html("Silahkan pilih no. purchase order!");
        $('.alert-danger').show(); 
...
function loadDetail(id){
    $.ajax({
        type:"POST",
        url:'<?php echo base_url('index.php/PengirimanAmpas/load_detail_surat_jalan'); ?>',
        data:"id="+ id,
...
function saveDetail(){
    if($.trim($("#ampas_id").val()) == ""){
        ...
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/PengirimanAmpas/save_detail_surat_jalan'); ?>',
            data:{
                id:$('#id').val(),
...
function hapusDetail(id){
    ...
    if (r==true){
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/PengirimanAmpas/delete_detail_surat_jalan'); ?>',
            data:"id="+ id,
            success:function(result){
                if(result['message_type']=="sukses"){
                    loadDetail($('#id').val());
