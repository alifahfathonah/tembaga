<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/RollingKawatHitam/edit'); ?>"> Create Surat Permintaan Barang (SPB) </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/RollingKawatHitam/update'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/RollingKawatHitam'); ?>" class="btn blue-hoki"> 
...
function loadDetail(id){
    $.ajax({
        type:"POST",
        url:'<?php echo base_url('index.php/RollingKawatHitam/load_detail'); ?>',
        data:"id="+ id,
...
function saveDetail(){
    if($.trim($("#rongsok_id").val()) == ""){
        ...
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/RollingKawatHitam/save_detail'); ?>',
            data:{
                id:$('#id').val(),
...
function hapusDetail(id){
    ...
    if (r==true){
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/RollingKawatHitam/delete_detail'); ?>',
            data:"id="+ id,
            success:function(result){
                if(result['message_type']=="sukses"){
                    loadDetail($('#id').val());
