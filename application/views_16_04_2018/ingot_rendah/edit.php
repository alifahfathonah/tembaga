<div class="row">
    <div class="col-md-12 alert-warning alert-dismissable">        
        <h5 style="color:navy">
            ...
            <a href="<?php echo base_url('index.php/IngotRendah'); ?>"> Pembelian Ingot Rendah </a> 
            <i class="fa fa-angle-right"></i> 
            <a href="<?php echo base_url('index.php/IngotRendah/edit'); ?>"> Edit Purchase Order </a> 
        </h5>          
    </div>
</div>
<div class="row">&nbsp;</div>
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <form class="eventInsForm" method="post" target="_self" name="formku" 
              id="formku" action="<?php echo base_url('index.php/IngotRendah/update'); ?>">                            
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="checkbox" id="flag_ppn" name="flag_ppn" value="1" <?php echo (($header['ppn']==1)? 'checked="checked"': ''); ?>> Flag PPN
                        </div>
                    </div>
                </div>              
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('index.php/IngotRendah'); ?>" class="btn blue-hoki"> 
...
function loadDetail(id){
    $.ajax({
        type:"POST",
        url:'<?php echo base_url('index.php/IngotRendah/load_detail'); ?>',
        data:"id="+ id,
...
function get_uom(id){
    $.ajax({
        url: "<?php echo base_url('index.php/IngotRendah/get_uom'); ?>",
        async: false,
        type: "POST",
        data: "id="+id,
        dataType: "json",
...
function saveDetail(){
    if($.trim($("#rongsok_id").val()) == ""){
        $('#message').html("Silahkan pilih item ingot!");
        $('.alert-danger').show(); 
        ...
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/IngotRendah/save_detail'); ?>',
            data:{
                id:$('#id').val(),
...
function hapusDetail(id){
    ...
    if (r==true){
        $.ajax({
            type:"POST",
            url:'<?php echo base_url('index.php/IngotRendah/delete_detail'); ?>',
            data:"id="+ id,
            success:function(result){
                if(result['message_type']=="sukses"){
                    loadDetail($('#id').val());
