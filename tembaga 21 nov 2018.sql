...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2018 at 01:03 PM
...
(21, '2018-10-29', 0, 0, 8, 6, 8, NULL, NULL, NULL, 'BPB-SDM.24102018.0001', 58, 45.948, '222', '251018M01770009', 19, 'M0009', 'BERES', 1, '2018-10-29 02:10:48', '2018-11-14', 1),
...
CREATE TABLE `t_sales_order` (
  `id` int(11) NOT NULL,
  `no_sales_order` int(50) NOT NULL,
  `tanggal` date NOT NULL,
  `m_customer_id` int(11) NOT NULL,
