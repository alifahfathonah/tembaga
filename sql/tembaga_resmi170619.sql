...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2019 at 06:50 AM
...
CREATE TABLE `r_dtr_detail` (
  ...
  `bruto` decimal(14,3) DEFAULT NULL,
  `berat_pallete` decimal(14,3) DEFAULT NULL,
  `netto` decimal(14,3) DEFAULT NULL,
...
CREATE TABLE `r_t_bpb_detail` (
  ...
  `qty` int(11) NOT NULL,
  `bruto` decimal(14,3) NOT NULL,
  `netto` decimal(14,3) NOT NULL,
...
CREATE TABLE `r_t_gudang_fg` (
  ...
  `bruto` decimal(14,3) NOT NULL,
  `netto` decimal(14,3) NOT NULL,
  `berat_bobbin` decimal(14,3) DEFAULT NULL,
...
CREATE TABLE `r_t_invoice_detail` (
  ...
  `jenis_barang_id` int(11) NOT NULL,
  `bruto` float(14,3) NOT NULL,
  `netto` float(14,3) NOT NULL,
  `berat_pallete` float(14,3) NOT NULL,
  `line_remarks` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `r_t_inv_jasa` (
  ...
  `nilai_invoice` decimal(14,3) DEFAULT '0.000',
...
CREATE TABLE `r_t_inv_jasa_detail` (
  ...
  `bruto` decimal(14,3) NOT NULL,
  `netto` decimal(14,3) NOT NULL,
  `amount` decimal(14,3) DEFAULT NULL,
